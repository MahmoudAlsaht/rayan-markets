...
import { deleteBrand } from '../_actions/deleteBrand';
...
export default function BrandsTable({
	...
	const columns: ColumnDef<Partial<Brand>>[] = [
		{
			accessorKey: 'name',
			header: () => (
		...
		},
		{
			...
			header: () => (
				<div className='text-right'>صورة العلامة</div>
			),
			cell: ({ row }) => (
				<Image
	...
	return (
		<div className='w-full'>
			<div className='flex items-center py-4'>
				...
				<Link href='/admin/settings/brands/new'>
